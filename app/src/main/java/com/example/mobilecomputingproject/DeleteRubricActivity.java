...
public class DeleteRubricActivity extends AppCompatActivity {

    ArrayList<RubricModel> rubricList = new ArrayList<RubricModel>();
    RecyclerView recyclerView;
    Button returnButton;

    CustomAdapterDel customAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delete_rubric);
        ...
        customAdapter = new CustomAdapterDel(getApplicationContext());
        ...
        returnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent newIntent = new Intent(DeleteRubricActivity.this, MainActivity.class);
