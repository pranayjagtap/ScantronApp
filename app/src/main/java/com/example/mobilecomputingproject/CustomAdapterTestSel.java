    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if(mode.equals("edit")) {
                ...
                System.out.println("grade mode");
                Intent newIntent = new Intent(mcon, edit_gradeTestSelActivity.class);
                String testName = testButton.getText().toString();
                int t = testName.indexOf(" Rev.");
                testName = testName.substring(0, t);
                newIntent.putExtra("mode", mode);
                ...
                newIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                mcon.startActivity(newIntent);
            } else if (mode.equals("test-stats")) {
                System.out.println("test-stats mode");
                Intent newIntent = new Intent(mcon, TestStatsPerQues.class);
                String testName = testButton.getText().toString();
                int t = testName.indexOf(" Rev.");
                testName = testName.substring(0, t);
                newIntent.putExtra("nameOfTest", testName);
